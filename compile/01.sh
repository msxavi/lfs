declare -a arr=("binutils-2.34.tar.xz" "gcc-9.2.0.tar.xz" "linux-5.5.4.tar.xz" "glibc-2.31.tar.xz" "gcc-9.2.0-2.tar.xz" "binutils-2.34-2.tar.xz" "gcc-9.2.0-3.tar.xz" "tcl8.6.10-src.tar.gz" "expect5.45.4.tar.gz"
